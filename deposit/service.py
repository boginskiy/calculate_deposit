...
def main_calculate_deposit(item: DataCalculate_IN):
    """Главная функция. Возвращает словарь, где ключом является интервалы дат,
    а значением нарастающие суммы депозита"""
